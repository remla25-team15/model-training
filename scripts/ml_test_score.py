...
class MLTestScoreCalculator:
    ...
    def __init__(self):
        self.test_categories = {
            ...
            'monitor': {
                ...
                'keywords': ['monitor', 'memory', 'latency', 'throughput', 'performance']
            },
            'metamorphic': {
                'weight': 10,
    ...
    def parse_junit_xml(self, xml_path: Path) -> Dict:
        ...
        results['passed'] = results['total_tests'] - results['failures'] - results['errors']
    ...
    def categorize_test(self, test_name: str, test_class: str) -> str:
        ...
        if 'serving' in test_name or 'validation' in test_name:
            return 'infra'
        elif 'robustness' in test_name or 'slice' in test_name or 'negative' in test_name:
            return 'model'
        elif 'memory' in test_name or 'latency' in test_name or 'throughput' in test_name:
            return 'monitor'
        elif 'mutamorphic' in test_name or 'metamorphic' in test_name or 'swap' in test_name:
            return 'metamorphic'
    ...
    def generate_recommendations(self, category_stats: Dict) -> List[str]:
    ...
    def save_results(self, output_path: Path, test_results: Dict, 
                    ...
                    metamorphic_score: float, recommendations: List[str]) -> None:
